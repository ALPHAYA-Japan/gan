...
class BGAN:
    ...
    def create_optimizer(self):
        ...
        self.ge_loss = tf.reduce_mean((tf.log(eps + self.d_fake)) ** 2)
        # self.ge_loss = 0.5 * tf.reduce_mean((tf.log(eps + self.d_fake) - tf.log(eps + 1 - self.d_fake))**2)
