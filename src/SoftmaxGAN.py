...
# Date : 2017-04
# Paper: Softmax GAN
# Link : https://arxiv.org/abs/1704.06191
...
class SoftmaxGAN:
    ...
    def __init__(self, model_path, data_path = None, is_training = False,
        ...
        # SoftmaxGAN Parameters
        self.model_name   = "SoftmaxGAN"
        self.gf_dim       = 64
    ...
    #................................................................................
    # DCGAN Discriminator Architecture (leaky_relu -> relu according to SoftmaxGAN authors)
    #................................................................................
    def discriminator(self, x, is_training=True, reuse=False):
        with tf.variable_scope("discriminator", reuse = reuse):
            ...
            net = tf.nn.relu(net) # it is originallly leaky_relu
    ...
    def create_optimizer(self):
        ...
        eps= 1e-04 # to avoid gradients vanishing
        Bd = 1.0 / self.batch_size
        Bg = 1.0 / (self.batch_size * 2)
        Z  = tf.log(eps + tf.reduce_sum(tf.exp(-self.d_real)) + tf.reduce_sum(tf.exp(-self.d_fake)))
        self.di_loss = Z + Bd * tf.reduce_sum(self.d_real)
        self.ge_loss = Z + Bg * (tf.reduce_sum(self.d_real) + tf.reduce_sum(self.d_fake))
