...
# Link : https://arxiv.org/abs/1705.07215
# Source 1: https://github.com/kodalinaveen3/DRAGAN (author implementation)
...
class DRAGAN:
    ...
    def __init__(self, model_path, data_path = None, is_training = False,
        ...
        # DRAGAN Parameters
        self.model_name   = "DRAGAN"
        self.k            = 1.0         #  1.0 is Proposed in the original paper
        self.c            = 1.0         # 10.0 is Proposed in the original paper
    ...
    def gradient_penalty(self, noise_type = "normal"):
        ...
        if noise_type == "uniform":
            ...
            alpha = tf.random.normal(shape = shape,
                                     mean  = 0.0,
                                     stddev= 1.0 * self.c)
        differences  = self.p_input - self.d_input
    ...
    def create_optimizer(self):
        ...
        eps = 1e-04 # to avoid gradients vanishing problem
        ...
        self.di_loss+= self.gradient_penalty(noise_type = "normal")
    ...
    def train(self, max_epoches, show_images = False):
        ...
        for epoch in range(max_epoches):
            for i in range(self.num_batches):
                ...
                x_batch_p  = self.get_perturbed_batch(np.asarray(x_batch))
