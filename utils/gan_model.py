...
class GAN_Model:
    ...
    # ...............................................................................
    # GAN_Model Architecture
    # ...............................................................................
    def create_network(self, with_logits = False):
        ...
        if with_logits == False:
            ...
            return self.d_real, self.d_fake, self.d_real_logits, self.d_fake_logits

    # ...............................................................................
    #
    # ...............................................................................
    def minimize_losses(self, di_loss, ge_loss):
        self.di_loss = di_loss
        self.ge_loss = ge_loss
    ...
    #         # z = np.random.uniform(-1.0, 1.0, size = [self.batch_size, self.latent_dim])
    #         z = np.random.normal(0.0, 1.0, size = [self.batch_size, self.latent_dim])
    #         g_output = self.graph.get_tensor_by_name("generator/main_out:0")
    #         g_input  = self.graph.get_tensor_by_name("ge_input:0" )
    #         g = self.session.run(g_output, feed_dict={g_input: z})
    #         for j in range(4):
    #             a[j][i].imshow(g[j])
    #
    #     f.show()
    ...
    #
    #................................................................................
    def generate(self, destination = None, samples = 20, grid_width=480, grid_height=240):
        ...
        grid   = self.construct_image_grid(preds,preds,samples,grid_width,grid_height)
